...
function __wbg_adapter_24(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2e9dea6d24611c4e(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {Promise<any>}
*/
export function get_places(search_string) {
    const ptr0 = passStringToWasm0(search_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_places(ptr0, len0);
...
*/
export function get_places_by_gpt(keywords) {
    const ptr0 = passStringToWasm0(keywords, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_places_by_gpt(ptr0, len0);
    return takeObject(ret);
}
...
* @returns {Promise<any>}
*/
export function get_interests(api, model, interest) {
    ...
    const ptr2 = passStringToWasm0(interest, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.get_interests(ptr0, len0, ptr1, len1, ptr2, len2);
    return takeObject(ret);
}
...
function __wbg_adapter_86(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h8eb4c55ea50195ec(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('dingdongdang_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
